export const FeralFileExhibitionV4_3 = {
  ABI: [
    {
      inputs: [
        ...
        },
        {
          ...
          internalType: 'struct FeralfileExhibitionV4_3.MergeArtworkInfo',
          name: 'mergeArtworkInfo_',
          type: 'tuple',
        },
      ],
    ...
    { inputs: [], name: 'InvalidMergingStatus', type: 'error' },
    ...
    { inputs: [], name: 'TokenIsNonMergeable', type: 'error' },
    {
      anonymous: false,
      inputs: [
        {
